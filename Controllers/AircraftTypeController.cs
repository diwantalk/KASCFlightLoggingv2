...
namespace KASCFlightLogging.Controllers
{
    ...
    public class AircraftTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] AircraftType aircraftType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] AircraftType aircraftType)
        {
