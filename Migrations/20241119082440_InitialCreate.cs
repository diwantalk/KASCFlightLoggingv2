    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightLogFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlightLogFields_AircraftTypes_AircraftTypeId",
                        column: x => x.AircraftTypeId,
                        principalTable: "AircraftTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightLogFieldId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightLogValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlightLogValues_FlightLogFields_FlightLogFieldId",
                        column: x => x.FlightLogFieldId,
                        principalTable: "FlightLogFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightReviews_AspNetUsers_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightReviews_FlightLogs_FlightLogId",
                        column: x => x.FlightLogId,
                        principalTable: "FlightLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "545d7f95-54ef-49c3-be0b-22abd3bc4d46", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "1", 0, "fe624c4e-3913-447b-912c-a1579529a660", "admin@kasc.com", true, "System", "Administrator", false, null, "ADMIN@KASC.COM", "ADMIN@KASC.COM", "AQAAAAIAAYagAAAAEMG+xFI6gsrTbomS9TI4r7cIOATSJ1pSrAFb1p+rUDEkFX1Ehq/XufvLM2SwP04tjA==", null, false, "6e2c463e-2f5c-49da-ab5e-e8138f74f437", false, "admin@kasc.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightLogFields_AircraftTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightLogValues_FlightLogFieldId",
                table: "FlightLogValues",
                column: "FlightLogFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightLogValues_FlightLogId",
                table: "FlightLogValues",
                column: "FlightLogId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightReviews_FlightLogId",
                table: "FlightReviews",
                column: "FlightLogId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightReviews_ReviewerId",
                table: "FlightReviews",
                column: "ReviewerId");
        }
