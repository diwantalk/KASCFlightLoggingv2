...
namespace KASCFlightLogging.Migrations
{
    ...
    [Migration("20241119082440_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fe624c4e-3913-447b-912c-a1579529a660",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMG+xFI6gsrTbomS9TI4r7cIOATSJ1pSrAFb1p+rUDEkFX1Ehq/XufvLM2SwP04tjA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6e2c463e-2f5c-49da-ab5e-e8138f74f437",
                            TwoFactorEnabled = false,
                            UserName = "admin@kasc.com"
                        });
                });

            modelBuilder.Entity("FlightReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KASCFlightLogging.Models.FlightLog", b =>
                {
                    ...
                    b.Property<int?>("NumberOfLandings")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "545d7f95-54ef-49c3-be0b-22abd3bc4d46",
                            Name = "Admin",
            ...
            modelBuilder.Entity("KASCFlightLogging.Models.Aircraft", b =>
                {
                    b.HasOne("KASCFlightLogging.Models.AircraftType", "Type")
                        .WithMany("Aircraft")
            ...
            modelBuilder.Entity("KASCFlightLogging.Models.FlightLogValue", b =>
                {
                    b.HasOne("KASCFlightLogging.Models.FlightLogField", "Field")
                        .WithMany()
